  ...
  resources: {
    en: {
      translation: {
        ...
        pls_flw:"Please follow the instructions sent by email to complete your booking",
    ...
    es: {
      translation: {
        ...
        pls_flw:"Por favor, siga las instrucciones enviadas por correo electrónico para completar su reserva",
        guests: "huéspedes",
    ...
    fr: {
      translation: {
        ...
        logout: "Déconnexion",
        login: "Connexion",
        pls_flw:"Veuillez suivre les instructions envoyées par e-mail pour finaliser votre réservation",
        home: "Accueil",
        rooms: "Chambres",
        findus: "Nous trouver",
        contact: "Contact",
    ...
    de: {
      translation: {
        ...
        reviews: "Bewertungen",
        explore: "Erkunden",
        pls_flw:"Bitte folgen Sie den Anweisungen, die Ihnen per E-Mail gesendet wurden, um Ihre Buchung abzuschließen",
        followus: "Folge uns",
        aboutus: "Über uns",
    ...
    it: {
      translation: {
        ...
        services: "Servizi",
        discover: "Scoprire",
        pls_flw:"Per favore segui le istruzioni che ti sono state inviate via email per completare la tua prenotazione",
