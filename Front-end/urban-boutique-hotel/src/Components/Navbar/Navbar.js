...
import { AiOutlineClose, AiOutlineMenu, AiOutlineHome, AiOutlineDatabase,
AiOutlineGlobal, AiOutlinePhone, AiOutlineUser, AiOutlineLogin } from "react-icons/ai";
// Images
      ...
      >
        ...
        <Link to="/" className="nav-link" onClick={handleClose}>
          <li className={`routes ${path === "/" ? "active" : ""}`}>
            <span style={{ display: "flex", alignItems: "center" }}>
              <AiOutlineHome style={{ marginRight: "0.4em" }} />
              {t("home")}
            </span>
          </li>
        </Link>
        <Link to="/rooms" className="nav-link" onClick={handleClose}>
          <li className={`routes ${path === "/rooms" ? "active" : ""}`}>
            <span style={{ display: "flex", alignItems: "center" }}>
              <AiOutlineDatabase style={{ marginRight: "0.4em" }} />
              {t("rooms")}
            </span>
          </li>
        </Link>
        ...
        <Link to="/discover" className="nav-link" onClick={handleClose}>
          <li className={`routes ${path === "/discover" ? "active" : ""}`}>
            <span style={{ display: "flex", alignItems: "center" }}>
              <AiOutlineGlobal style={{ marginRight: "0.4em" }} />
              {t("discover")}
            </span>
          </li>
        </Link>
        <Link to="/contact" className="nav-link" onClick={handleClose}>
          <li className={`routes ${path === "/contact" ? "active" : ""}`}>
            <span style={{ display: "flex", alignItems: "center" }}>
              <AiOutlinePhone style={{ marginRight: "0.4em" }} />
              {t("contact")}
            </span>
          </li>
        </Link>
        ...
        {isLoggedIn ? (
          <div className="login-btn" id="login-btn">
            <div className="nav-link" onClick={handleAccount}>
              <div className="login-img">
                <AiOutlineUser className="nav-image" />
              </div>
          ...
          <div className="login-btn" id="login-btn">
            <Link to="/login" className="nav-link" onClick={handleClose}>
              <div className="login-img">
                <AiOutlineLogin className="nav-image" />
              </div>
