...
use App\Http\Controllers\GetUsersEmailsController;
...
Route::group(["prefix"=>"v0.1"], function(){
    ...
    Route::group(['prefix'=>'room'],function(){
        ...
        Route::group(['prefix'=>'reservation'],function(){
            Route::middleware(['auth', 'check.reservationmanager'])->group(function(){
                ...
                Route::post('confirm/{reservationid}',[CustomerController::class,'confirmReservation']);
            });
            Route::middleware(['auth', 'check.admin'])->group(function(){
            ...
            Route::middleware(['auth', 'check.customer'])->group(function(){
                ...
                Route::post('reservebycard',[CustomerController::class,'reserveRoomByCard']);
    ...
    Route::post('/card-pay', [CardPaymentController::class, 'cardPay']);
    ...
    Route::group(['prefix'=>'getemails'],function(){
        Route::middleware(['auth', 'check.contentmanager'])->group(function(){
            Route::get('get',[GetUsersEmailsController::class,'getEmails']);
        });
    });
